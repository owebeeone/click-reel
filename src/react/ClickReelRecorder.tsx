...
export interface ClickReelRecorderProps {
  ...
  /** Callback when preview obfuscation is toggled */
...
export function ClickReelRecorder({
  ...
  // Consolidated action handlers - single source of truth
  const handleArmCapture = useCallback(() => {
  ...
  // Setup keyboard shortcuts using consolidated handlers
  useKeyboardShortcuts(
    {
      onToggleRecorder: () => {
        dispatch({ type: ActionType.TOGGLE_RECORDER_UI });
      },
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  cursor:
                    recorder.state === "armed" ? "not-allowed" : "pointer",
                  color: "white",
                  display: "flex",
                  alignItems: "center",
              ...
              <button
                onClick={(e) => {
                  ...
                  if (isObfuscating) {
                    ...
                    onPreviewObfuscationToggle?.(false);
                  } else {
                    ...
                    onPreviewObfuscationToggle?.(true);
                  }
                }}
                style={{
                  padding: "8px",
